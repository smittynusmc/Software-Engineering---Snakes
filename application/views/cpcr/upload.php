...
<div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="cpcr_upload-title"> Import CPCR</h4>
        </div>
        <div class="modal-body" id="cpcr_upload-body">
            <?php echo form_open('CPCR/upload',array('id'=>'cpcr_upload_form')); ?>
            <div class="box-body" >
        ...
        <div class="modal-footer" id="cpcr_upload-footer">
            <div class="box-footer">
                <button type="submit" class="btn btn-primary submit-button" formid="cpcr_upload_form">Submit</button>
            </div>
        </div>
        <div class="modal-footer" id="cpcr_upload-result">
            <?php
			if(!empty($error)){
