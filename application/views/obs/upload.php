...
<div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="obs_upload-title"> Add New Project</h4>
        </div>
        <div class="modal-body" id="obs_upload-body">
            <?php echo form_open('OBS/upload',array('id'=>'obs_upload_form')); ?>
            <div class="box-body" >
        ...
        <div class="modal-footer" id="obs_upload-footer">
            <div class="box-footer">
                <button type="submit" class="btn btn-primary submit-button" formid="obs_upload_form">Submit</button>
            </div>
        </div>
        <div class="modal-footer" id="obs_upload-result">
            <?php
            if(isset($result)){
