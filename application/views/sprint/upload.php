...
<div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="sprint_insert-title"> Import Sprint</h4>
        </div>
        <div class="modal-body" id="sprint_insert-body">
            <?php echo form_open('Sprint/upload',array('id'=>'sprint_upload_form')); ?>
            <div class="box-body" >
        ...
        <div class="modal-footer" id="sprint_insert-footer">
            <div class="box-footer">
                <button type="submit" class="btn btn-primary submit-button" formid="sprint_upload_form">Submit</button>
            </div>
        </div>
