...
<i class='glyphicon glyphicon-pencil'></i> <a class='function-button' archo='<?php echo base_url(); ?>index.php/Product/get_edit/<?php echo $Product_Code; ?>'  title='Edit Current Product'>Edit</a>
<?php }?>  
&nbsp;
