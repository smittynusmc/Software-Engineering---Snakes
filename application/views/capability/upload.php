...
<div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="capability_upload-title"> Import Capability</h4>
        </div>
        <div class="modal-body" id="capability_upload-body">
