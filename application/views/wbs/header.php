...
&nbsp;
<?php if(!empty($wbs_id)){ ?>
<i class='glyphicon glyphicon-pencil'></i> <a class='function-button' archo='<?php echo base_url(); ?>index.php/WBS/get_edit/<?php echo $wbs_id; ?>'  title='Edit Current Project'>Edit</a>
<?php }?>  
&nbsp;
